...
# Update and Build the website to the build folder
npm update
npm run build

#copy the contents of the build folder to backend
...
#node_modules/typescript/bin/tsc app.js --strict --outFile $TARGETFOLDER/$WEBFOLDERNAME/app.js
