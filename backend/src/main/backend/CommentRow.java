...
public class CommentRow {
     ...
     * @param messageId he unique identifier associated with the corisponding message
     * @param user The unique identifier associated with the user who made the comment
